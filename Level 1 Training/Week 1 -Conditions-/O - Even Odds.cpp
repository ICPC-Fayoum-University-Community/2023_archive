...
----------------------------- n is odd -----------------
  ...
  let m = ceil((double)n/2)

  if k <= m  then we are in odd numbers position
  to get the number in that odd position we use the following formula:  2 * m - 1


  if k > m then we are in even numbers position
